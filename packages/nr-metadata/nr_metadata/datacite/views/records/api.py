def create_api_blueprint(app):
    """Create DataciteRecord blueprint."""
    blueprint = app.extensions["nr_metadata.datacite"].resource_records.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_datacite") and callable(v)
    ]
    for func in funcs:
...
def init_create_api_blueprint(state):
    """Init app."""
    app = state.app
    ext = app.extensions["nr_metadata.datacite"]
